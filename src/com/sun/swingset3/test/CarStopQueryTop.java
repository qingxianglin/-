 ...
 * @author lin lego
 */
public class CarStopQueryTop extends JPanel {
    public CarStopQueryTop(JTabbedPane parentTabbedPanel) {
    ...
    private void initComponents(final JTabbedPane parentTabbedPanel) {
      ...
      //  add(label4, CC.xy(5, 3));
       ...
       // add(label3, CC.xy(11, 3));
        ...
        //---- button7 ----
        button7.setText("\u67e5\u8be2");
        add(button7, CC.xy(9, 9));

        button8.setText("新建停车场");
        button8.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                parentTabbedPanel.add("新建停车场",new TableDemo5(parentTabbedPanel).getDemoPanel());
                parentTabbedPanel.setSelectedIndex(1);
            }
        });
        add(button8, CC.xy(11, 9));
