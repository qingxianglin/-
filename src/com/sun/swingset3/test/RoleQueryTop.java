...
import com.sun.swingset3.demos.aaa.RoleCreatePanel;
 ...
 * @author lin lego
 */
public class RoleQueryTop extends JPanel {
    public RoleQueryTop(JTabbedPane parentTabbedPanel) {
       ...
       /* setBorder(new javax.swing.border.CompoundBorder(
        ...
        button2.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                parentTabbedPanel.addTab("新增角色",new RoleCreatePanel(parentTabbedPanel).getDemoPanel());
