...
import com.sun.swingset3.demos.aaa.UserCreatePanel;
 ...
 * @author lin lego
 */
public class UserQueryTop extends JPanel {
    public UserQueryTop(JTabbedPane parentTabbedPanel) {
       ...
       /* setBorder(new javax.swing.border.CompoundBorder(
        ...
        button2.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                parentTabbedPanel.addTab("新增管理员",new UserCreatePanel(parentTabbedPanel).getDemoPanel());
