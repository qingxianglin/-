 ...
 * @author lin lego
 */
public class CarOutSuccess extends JPanel {
    public CarOutSuccess(final JTabbedPane parentTabbedPane, CarInBean carInBean) {
    ...
    private void initComponents(CarInBean carInBean) {
        ...
        label1 = new JLabel();
        separator1 = compFactory.createSeparator("本次车辆出场信息明细");
        table1 = new JTable();
        ...
        table1.setModel(new DefaultTableModel(
            new Object[][] {
                ...
                {"车辆出场时间:", sdf.format(carInBean.getCarOutTime())},
                {"停车场收费标准:", carInBean.getCostStandard()},
                {"停车场期间费用:", null},
