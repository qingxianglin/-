 ...
 * 卡片发行界面的表单
 */
public class CarInLeft extends JPanel{
    public CarInLeft() {
        initComponents();
    }

    public void setCarInInfo(CarInBean carInBean){
        Date d = new Date();
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        textField7.setText(sdf.format(carInBean.getCarInTime()));
        ...
        passwordField1.setText(carInBean.getCardId()+"");
    }
