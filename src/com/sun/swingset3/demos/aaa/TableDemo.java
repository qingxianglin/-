...
public class TableDemo extends DemoModule {
    String carInPicturePath = null;
    String carInPictureName = null;
    ...
    JLabel headerLabel2 = new JLabel("停车场ID:");

    JLabel footerLabel;

    JLabel footerLabel1;

    JLabel footerLabel2 = new JLabel("收费员工号:");
    ...
    JTextField footerTextField2 = new JTextField(25);

    JTextField headerTextField2 = new JTextField(25);
    ...
    public TableDemo(final JTabbedPane parentTabbedPanel) {
        ...
        printButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                ...
                parentTabbedPanel.addTab("停车位动态调度",
                        new TableDemo2(parentTabbedPanel,carInBean).getDemoPanel());
        ...
        printPanel.add(headerLabel2);
        printPanel.add(headerTextField2);
        printPanel.add(footerLabel);
        printPanel.add(footerTextField);
        printPanel.add(footerLabel2);
        printPanel.add(footerTextField1);
        printPanel.add(footerLabel1);
        printPanel.add(footerTextField2);
...
//	  {"James", "Gosling",    pink,        getString("TableDemo.tennis"), new Double(21), donut},
    ...
    class OpenActionListener implements MouseListener {
        ...
        public void mouseClicked(MouseEvent e) {
            ...
            carInPicturePath = fileChooser.getSelectedFile().getPath();
            carInPictureName = fileChooser.getSelectedFile().getName().substring
    ...
    class RecognizeTask extends TimerTask {
        ...
        public void run() {
            ...
            image.setImage(img);
            loading.setIcon(image);
            carInBean.setCarNo(carInPictureName);
            carInBean.setCarInPicturePath(carInPicturePath);
            carInBean.setCarInTime(new Date());
            carPlateNo.setText(carInBean.getCarNo());
            footerTextField2.setText(carInBean.getCarNo());
            SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
            headerTextField.setText(sdf.format(carInBean.getCarInTime()));
            headerTextField1.setText(carInBean.getAddress());
            footerTextField1.setText(carInBean.getManagerId()+"");
            headerTextField2.setText(carInBean.getParkingLotId()+"");
            footerTextField.setText(carInBean.getManagerName());
        }
    }
}
