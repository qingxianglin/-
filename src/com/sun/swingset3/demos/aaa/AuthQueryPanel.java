...
public class AuthQueryPanel extends DemoModule {
    ...
    public AuthQueryPanel(final JTabbedPane parentTabbedPanel) {
        ...
        comboPanel2.add(tableDemo11.getDemoPanel(),BorderLayout.CENTER);
        // print panel
