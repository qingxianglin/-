...
import com.sun.swingset3.test.JAutoCompleteComboBox;
...
public class TableDemo5 extends DemoModule {
    ...
    JLabel tipImg1Text = new JLabel("停车场入口处所在位置:");

    JLabel tipImg2 = new JLabel();

    JLabel tipImg2Text = new JLabel("停车场出口处所在位置:");
    ...
    JAutoCompleteComboBox chargerTextField = new JAutoCompleteComboBox(new DefaultComboBoxModel());

    JAutoCompleteComboBox adminTextField = new JAutoCompleteComboBox(new DefaultComboBoxModel());
    ...
    public TableDemo5(final JTabbedPane parentTabbedPane) {
        ...
        final CreateMazeProblem maze  = new CreateMazeProblem(null);
        ...
        printPanel.setBorder(new TitledBorder("新建停车场"));
        headerLabel = new JLabel("停车场地址:");
        headerLabel1 = new JLabel("收费员姓名:");
        footerLabel = new JLabel("负责人姓名:");
        footerLabel1 = new JLabel("停车场收费标准:");
        stopSpace = new JLabel("停车位数量:");
        ...
        printButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                ...
                ManagerBean charger = new ManagerBean(Integer.parseInt(chargerTextField.getText().split("-")[1]),
                        chargerTextField.getText().split("-")[0],ManagerBean.CHARGER);
                ManagerBean admin = new ManagerBean(Integer.parseInt(adminTextField.getText().split("-")[1]),
                        adminTextField.getText().split("-")[0],ManagerBean.ADMIN);
                parkingLotBean.getManagerBeanList().add(charger);
                parkingLotBean.getManagerBeanList().add(admin);
                parkingLotBean.setAddress(headerTextField.getText());
                parkingLotBean.setChargeStandard(new BigDecimal(footerTextField1.getText()));
                parkingLotBean.setSelectedParkingSpace(maze.selectedParkingSpace);
                parkingLotBean.setSelectedEntry(maze.selectedEntry);
                parkingLotBean.setSelectedExit(maze.selectedExit);
                parkingLotDBUtils.createParkingLot(parkingLotBean);
                parentTabbedPane.setSelectedIndex(0);
                parentTabbedPane.removeTabAt(1);
                //parentTabbedPane.add("读取IC卡信息", new TableDemo1(parentTabbedPane,null).getDemoPanel());
        ...
        printPanel.add(chargerTextField);
        printPanel.add(footerLabel);

        printPanel.add(adminTextField);
