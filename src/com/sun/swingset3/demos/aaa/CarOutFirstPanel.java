...
public class CarOutFirstPanel extends DemoModule {
    ...
    public CarOutFirstPanel(final JTabbedPane parentTabbedPanel) {
        ...
        JPanel comboPanel2 = new JPanel(new GridLayout(2, 1));
        ...
        selectMode.setBorder(new TitledBorder("车辆进场抓拍照片"));

        JPanel selectMode2 = new JPanel();
        selectMode2.setLayout(new BoxLayout(selectMode2, BoxLayout.X_AXIS));
        selectMode2.setBorder(new TitledBorder("车辆出场抓拍照片"));
        ...
        comboPanel.setBorder(new TitledBorder("车辆进场信息"));
        comboPanel2.setBorder(new TitledBorder("车辆出场信息"));
        comboPanel2.add(selectMode2);
        ...
        resizeMode.setBorder(new TitledBorder("车辆进场信息"));
        resizeMode.add(carInLeft);

        JPanel resizeMode2 = new JPanel();
        resizeMode2.setLayout(new BoxLayout(resizeMode2, BoxLayout.Y_AXIS));
        resizeMode2.setBorder(new TitledBorder("车辆出场信息"));
        carInRight = new CarInRight(parentTabbedPanel);
        resizeMode2.add(carInRight);
        ...
        carInImage2.setSize(232, 248);
        carInImage.setSize(232, 248);
        ...
        carInImage2.addMouseListener(new OpenActionListener2());
        selectMode.add(carInImage);
        selectMode2.add(carInImage2);
        ...
        System.out.println(selectMode.getPreferredSize());
        System.out.println(selectMode2.getPreferredSize());
    } // TableDemo()
...
//          tableView.setRowSorter(sorter);
    ...
    class RecognizeTask extends TimerTask {
        ...
        public void run() {
            ...
            image.setImage(img);
            carInImage.setIcon(image);
            carInLeft.setCarInInfo(carInBean);
            carInRight.setCarInfo(carInBean);
        }
    }
}
