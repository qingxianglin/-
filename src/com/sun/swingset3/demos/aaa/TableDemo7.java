...
public class TableDemo7 extends DemoModule {
    ...
    public TableDemo7(final JTabbedPane parentTabbedPane) {
        ...
        final MazeProblem1 maze  = new MazeProblem1(null,null);
        ...
        printPanel.setBorder(new TitledBorder("停车位查询面板"));
        headerLabel = new JLabel("停车场地址:");
        headerLabel1 = new JLabel("收费员姓名:");
        footerLabel = new JLabel("车牌号码:");
        ...
        headerTextField.setText(carInBean.getAddress());
        headerTextField1.setText(carInBean.getManagerName());
