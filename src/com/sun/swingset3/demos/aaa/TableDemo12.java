...
public class TableDemo12 extends DemoModule {
    ...
    class PageList{
        ...
        public Object[][] findData(RoleBean queryBean,int currentPage, int pageSize){
            int totalRowCount = parkingLotDBUtils.queryRoleByConditionCount(queryBean);
            if(currentPage<1){
                currentPage=1;
            }
            ...
            List<RoleBean> temp = parkingLotDBUtils.queryRoleByCondition(queryBean,startIndex,endIndex);
            Object[][] tempList = new Object[endIndex-startIndex][];
            int index = 0;
            SimpleDateFormat sdf = new SimpleDateFormat("YYYY年-MM月-DD日 HH时:MM分:SS秒");
            for(int i = startIndex;i<endIndex;++i){
                RoleBean tempbean = temp.get(index);
        ...
        public void showTable(RoleBean queryBean,int currentPage){
    ...
    public TableDemo12(final JTabbedPane parentTabbedPanel) {
...
/*
    ...
    public void query(RoleBean queryBean){
