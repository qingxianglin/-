...
public class TableDemo11 extends DemoModule {
    ...
    class PageList{
        ...
        public Object[][] findData(AuthBean queryBean,int currentPage, int pageSize){
            int totalRowCount = parkingLotDBUtils.queryAuthByConditionCount(queryBean);
            if(currentPage<1){
                currentPage=1;
            }
            ...
            List<AuthBean> temp = parkingLotDBUtils.queryAuthByCondition(queryBean,startIndex,endIndex);
            Object[][] tempList = new Object[endIndex-startIndex][];
            int index = 0;
            SimpleDateFormat sdf = new SimpleDateFormat("YYYY年-MM月-DD日 HH时:MM分:SS秒");
            for(int i = startIndex;i<endIndex;++i){
                AuthBean tempbean = temp.get(index);
                tempList[index] = new Object[]{tempbean.getId(),tempbean.getPath(),tempbean.getNameZh(),tempbean.getNameEn(),tempbean.getRemark()};
                ++index;
            }
        ...
        public void showTable(AuthBean queryBean,int currentPage){
    ...
    public TableDemo11(final JTabbedPane parentTabbedPanel) {
...
/*
    ...
    public void query(AuthBean queryBean){
