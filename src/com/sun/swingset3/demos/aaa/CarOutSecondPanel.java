...
public class CarOutSecondPanel extends DemoModule {
    ...
    public CarOutSecondPanel(final JTabbedPane parentTabbedPane) {
        ...
        printButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                parentTabbedPane.addTab("车辆出场",new CarOutSuccess(parentTabbedPane,null));
