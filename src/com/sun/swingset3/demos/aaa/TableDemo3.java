...
import com.sun.swingset3.test.CarOutSuccess;
...
public class TableDemo3 extends DemoModule {
    ...
    JTextField carOutTimeField = new JTextField(25);

    JLabel carOutTime = new JLabel("车辆出场时间:");

    JTextField stopTimeField = new JTextField(25);

    JLabel stopTime = new JLabel("累计停车时间:");

    JTextField costStandardField = new JTextField(25);

    JLabel costStandard = new JLabel("停车收费标准:");
    ...
    JTextField cardNoField = new JTextField(25);
    ...
    public TableDemo3(final JTabbedPane parentTabbedPane, final CarInBean carInBean) {
        ...
        printButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                ...
                parkingLotDBUtils.createCarOutLog(carInBean);
                parentTabbedPane.addTab("车辆出场",new CarOutSuccess(parentTabbedPane,carInBean));
        ...
        printPanel.add(carOutTime);
        printPanel.add(carOutTimeField);
        carOutTimeField.setText(sdf.format(carInBean.getCarOutTime()));
        printPanel.add(stopTime);
        printPanel.add(stopTimeField);
        printPanel.add(costStandard);
        printPanel.add(costStandardField);
        costStandardField.setText(carInBean.getCostStandard()+"");
        ...
        cardNoField.setText(carInBean.getCardId()+"");
