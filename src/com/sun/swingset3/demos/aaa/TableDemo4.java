...
public class TableDemo4 extends DemoModule {
    Object[][] data= null;
    ...
    class PageList{
        ...
        public Object[][] findData(int currentPage, int pageSize){
            ...
            java.util.List<ParkingLotBean> temp = parkingLotDBUtils.queryParkingLotBean(null,startIndex,endIndex);
            Object[][] tempList = new Object[endIndex-startIndex][];
            int index = 0;
            SimpleDateFormat sdf = new SimpleDateFormat("YYYY年-MM月-DD日 HH时:MM分:SS秒");
            for(int i = startIndex;i<endIndex;++i){
                ParkingLotBean tempbean = temp.get(index);
                tempList[index] = new Object[]{tempbean.getParkingLotId(),sdf.format(tempbean.getCreatedTime().getTime()),tempbean.getAddress(),tempbean.getManagerName(),tempbean.getChargeStandard(),
                        tempbean.getCount()};
                ++index;
            }
