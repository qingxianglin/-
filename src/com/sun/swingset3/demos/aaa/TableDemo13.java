...
public class TableDemo13 extends DemoModule {
    UserBean queryBean = new UserBean();
    Object[][] data= null;
    ...
    class PageList{
        ...
        public Object[][] findData(UserBean queryBean,int currentPage, int pageSize){
            int totalRowCount = parkingLotDBUtils.queryUserCountByCondition(queryBean);
            if(currentPage<1){
                currentPage=1;
            }
            ...
            List<UserBean> temp = parkingLotDBUtils.queryUserByCondition(queryBean,startIndex,endIndex);
            Object[][] tempList = new Object[endIndex-startIndex][];
            int index = 0;
            SimpleDateFormat sdf = new SimpleDateFormat("YYYY年-MM月-DD日 HH时:MM分:SS秒");
            for(int i = startIndex;i<endIndex;++i){
                UserBean tempbean = temp.get(index);
                tempList[index] = new Object[]{tempbean.getId(),tempbean.getName(),tempbean.getIdCard(),tempbean.getSex(),tempbean.getPhonex(),new ImageIcon(tempbean.getPicturePath())};
                ++index;
            }
        ...
        public PageList(){
            ...
            prePageButton.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    showTable(queryBean,getCurrentPage()-1);
                }
            });
            ...
            nextPageButton.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    if(getCurrentPage()<getLastPage()){
                        ...
                        showTable(queryBean,getLastPage());
                    }
                }
            });
            ...
            showTable(queryBean,currentPage);
        }
        ...
        public void showTable(UserBean queryBean,int currentPage){
            setCurrentPage(currentPage);
            currentData=findData(queryBean,currentPage, pageSize);
            tableView.repaint();
            scrollpane.updateUI();
        }
    ...
    public TableDemo13(final JTabbedPane parentTabbedPanel) {
...
/*
    ...
    public void query(UserBean queryBean){
        this.queryBean = queryBean;
        pageList.setUp();
        pageList.showTable(queryBean,pageList.getCurrentPage());
    }
}
