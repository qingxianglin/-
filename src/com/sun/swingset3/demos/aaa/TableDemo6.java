...
public class TableDemo6 extends DemoModule {
    Object[][] data= null;
    ...
    class PageList{
        ...
        public Object[][] findData(int currentPage, int pageSize){
            int totalRowCount = parkingLotDBUtils.queryCarInBeanCount(null);
            if(currentPage<1){
                currentPage=1;
            }
            ...
            java.util.List<CarInBean> temp = parkingLotDBUtils.queryCarInBean(null,startIndex,endIndex);
    ...
    public TableDemo6(final JTabbedPane parentTabbedPanel) {
